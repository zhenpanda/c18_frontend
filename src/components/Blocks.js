...
import BlockThree from '../assets/images/blockHospital.png';
...
class Blocks extends Component {
    ...
    render() {
        ...
        if(this.props.block === "one") {
            return(
                <div className="block-block z-depth-3 moveFromTopFade delay400">
            ...
            return(
                <div className="block-block-two z-depth-3 moveFromTopFade delay200">
